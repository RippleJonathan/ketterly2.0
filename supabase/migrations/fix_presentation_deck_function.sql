-- Fix get_presentation_deck function
-- Issue: Function tries to access non-existent columns and uses wrong column names
...
BEGIN
  ...
  -- Get estimate data if provided (from quotes table)
