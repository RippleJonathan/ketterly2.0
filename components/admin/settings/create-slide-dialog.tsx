...
import { useCreatePresentationSlide } from '@/lib/hooks/use-presentations'
import { toast } from 'sonner'
import type { FlowType, SlideType } from '@/lib/types/presentations'
...
export function CreateSlideDialog({
  ...
  const form = useForm<SlideFormData>({
    ...
    defaultValues: {
      title: '',
      slideType: 'static',
      showForRetail: templateFlowType === 'retail' || templateFlowType === 'both',
      showForInsurance: templateFlowType === 'insurance' || templateFlowType === 'both',
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl max-h-[85vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new slide for this presentation template
          </DialogDescription>
        </DialogHeader>
