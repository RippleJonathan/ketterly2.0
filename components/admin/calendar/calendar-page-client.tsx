...
export function CalendarPageClient({
  ...
  const [currentView, setCurrentView] = useState<CalendarView>(CalendarView.DAY)
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Edit Event Modal - reuse QuickAdd modal with event data */}
      {editingEvent && (
        <EventQuickAddModal
          open={!!editingEvent}
          ...
          canCreateConsultations={canCreateConsultations}
          canCreateProductionEvents={canCreateProductionEvents}
          defaultDate={editingEvent.event_date}
